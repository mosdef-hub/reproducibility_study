...
gomc_binary_path = "/wsu/home/go/go07/go0719/GOMC/2_21_2022GOMCinstallDev/GOMC/bin" #/home6/maxim/gregFixedHvapInstall/GOMCinstall/GOMC/bin   /wsu/home/go/go07/go0719/GOMC/2_21_2022GOMCinstallDev/GOMC/bin
...
@FlowProject.pre(lambda *jobs: all(part_4c_job_equilb_design_ensemble_completed_properly for job in jobs))#beware of string issue: if u have an old version cast the long range correction as str(long_range_correction)
    ...
    for job in jobs:
        ...
        with(job):
            ...
            if job.isfile(str("Blk_"+production_control_file_name_str+"_BOX_1.dat")):
                ...
                trajJustin = md.load('production_run_BOX_0.dcd', top='mosdef_box_0.pdb')
...
@FlowProject.pre(lambda *jobs: all(part_4c_job_equilb_design_ensemble_completed_properly for job in jobs))#part_4c_job_equilb_design_ensemble_completed_properly
...
def analysis(*jobs):
    ...
    moreDateHere = open("averagesWithinReplicatez.txt","a+")#open("averagesWithinReplicatez.txt","a+")
